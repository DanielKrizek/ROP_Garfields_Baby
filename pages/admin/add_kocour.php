...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO toms (name, birth_date, color_pattern, color_code, main_image, gallery_images) VALUES (?, ?, ?, ?, ?, ?)");
...
<body>
    <a href="manage_toms.php">Zpět na správu kocourů</a>
