...
(29, 'hnup', '$2y$10$Ey9ZknZvG8/h31PurSsGTOgAuVJ7oQ1ju94/FW7m/mEGOub8zNLsu', 'user'),
(30, 'nnn', '$2y$10$tcz.kqN1XIuZqUFZTYRFDu7jjdBW4QNYMVWQQ186bMfjj1TlHCx7i', 'user'),
(31, 'zloun', '$2y$10$j.Q7C1BAaln5Kb.lWLOFueVXae7l.DSbqm48vu4GL4vTyPofbl0WG', 'user'),
(32, '<script>alert(\"1\")</script>', '$2y$10$1LcSgeR9jQFTjzx.wr9cduUgYA3XWVySZ5y3tZKwT8grZZHBSuHgq', 'user'),
(34, '&lt;script&gt;alert(&quot;1&quot;)&lt;/script&gt;', '$2y$10$yvYZZwJgfdGN4y8HaFCoW.DTJTHSAt3JY9gd4kIsEadv9B2gZ1bRG', 'user'),
(35, 'papa', '$2y$10$Z/D.fh/B..TCt6u7CT8BzO/T3YLP8JWsCa7w0yypXS44P6yTXkVr.', 'user'),
(36, 'fffff', '$2y$10$PDYzYGqmHwoPNKZAVQbgHuz8VZTq/KQCBme19bJlKPdr22pLflIPy', 'user');
